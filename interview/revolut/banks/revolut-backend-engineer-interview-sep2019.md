...
**Language insisted upon by interviewers: Java** *(the candidate had never worked in Java professionally)*

**Problem 1:** Write a frequency counter
- Count the frequency of elements in a collection

**Follow-up constraints added progressively:**
- *What if the data won't fit in memory?* → Think: streaming / external memory / disk-based approaches
- *What if the function is called by many threads simultaneously?* → Think: thread safety, concurrency, locks, ConcurrentHashMap
...
*Captured from LeetCode Discuss — https://leetcode.com/discuss/post/651695/revolut-backend-engineer-london-sep-2019-pi0l/*
