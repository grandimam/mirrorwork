...
2. If NO → prompt to run `/mirrorwork init`
...
|---------|---------|--------|
| `/mirrorwork reflect` | Weekly reflection | Planned |
| `/mirrorwork feedback` | Digest feedback | Planned |
| `/mirrorwork prep` | Interview prep | Planned |
| `/mirrorwork interview` | Interview practice | Planned |
